# Simulated Control Panel Demo

Учебный DEMO-проект на FastAPI + SQLModel + Jinja2/HTMX/Alpine + Chart.js.

> Важно: только симуляция телеметрии и событий. Никаких реальных сетевых подключений/туннелей/обходов.
