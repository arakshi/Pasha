...
def init_db() -> None:
    ...
    with Session(engine) as session:
        ...
        profiles = [
            ...
            Profile(name="VLESS (симуляция)", latency_factor=0.86, error_factor=0.95, throughput_factor=1.06, description="Имитация профиля транспортного режима VLESS без реального сетевого подключения."),
        ]
